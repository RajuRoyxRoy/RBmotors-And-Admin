...
<div class="sidebar">
        ...
        <ul class="sidebar-menu">
            ...
            <li><a href="salary_calculation.php" class="active"><i class="fas fa-file-invoice"></i><span>Salary Calculation</span></a></li>
    ...
    <script>
        function calculateTotal(clientId, baseSalary, hourlySalary) {
            ...
            let totalSalary = baseSalary + bonus + (extraHours * hourlySalary);
            document.getElementById("total_salary_" + clientId).textContent = totalSalary.toFixed(2);
        }
    </script>
